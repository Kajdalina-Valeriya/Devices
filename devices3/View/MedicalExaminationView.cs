...
namespace View
{
    public partial class MedicalExaminationView : Form
    {
        ...
        private void humanPic_Click(object sender, EventArgs e)
        {

        }

        private void spirometerPic_Click(object sender, EventArgs e)
        {
        ...
        private void termometerCheckBox_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void ThermometerPic_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Градусник исправен");
        }

        private void PressurePic_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Прибор, измеряющий давление, исправен");
        }

        private void PulsometerPic_Click(object sender, EventArgs e)
        {
           
                MessageBox.Show("Прибор, измеряющий пульс, исправен");
            
        }

        private void SkinMoisturePic_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Прибор, измеряющий влажность кожи, исправен");
        }

        private void ElectricalConductivityPic_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Прибор, измеряющий электрическую проводимость кожи, исправен");
        }
    }
}
