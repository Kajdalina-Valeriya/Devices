...
namespace View
{
    public partial class NewExaminationView : Form
    {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                stringListOfSensors += "pressure  ";
            }
            if (skinMoistureCheckBox.Checked)
            {
                stringListOfSensors += "skin moisture  ";
            }

            if (electricalConductivityCheckBox.Checked)
            {
                stringListOfSensors += "electrical conductivity  ";
            }
